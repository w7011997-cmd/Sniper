...
function ActivityIcon({ kind }: { kind: ActivityKind }) {
  ...
  if (kind === "wallet") return <div className="activity-icon"><Layers size={16} /></div>;
  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-card">
        ...
        <Link to="/collections" className="profile-row" style={{ textDecoration: "none", color: "inherit" }}>
          <div className="profile-row-icon"><Layers size={16} /></div>
          <div style={{ flex: 1 }}>
            <div className="stat-secondary">My collections</div>
            <div className="profile-row-value">Cues, trails & tables you own</div>
          </div>
          <div className="chevron">›</div>
        </Link>
      </div>
